...
For local development, set `ORIGIN=http://localhost:5173` and keep the data in the project, for example `DATABASE_PATH=./data/servitor.db` and `UPLOADS_DIR=./data/uploads`.
