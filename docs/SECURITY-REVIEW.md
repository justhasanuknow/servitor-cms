...
6. Pages with a one-time token in their address send `Referrer-Policy: no-referrer` (V14.2.1).
...
| HSTS, `nosniff`, `Referrer-Policy`, `Permissions-Policy`, `Cross-Origin-Opener-Policy`                         | Pass   | Now on every response, static files included; token pages use `no-referrer` |
...
| V3.4.5 | 2     | Pass   | `Referrer-Policy: strict-origin-when-cross-origin` on every response, and `no-referrer` on pages whose address carries a one-time token.                                                                                                                      |
